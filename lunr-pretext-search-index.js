...
},
{
  ...
  "number": "1.1.15",
  "title": "",
  "body": "   Each graph below is the graph of a system of three linear equations in three unknowns. Determine whether each system has a solution and, if it does, the dimension of the solution space.               A.  choose  no solution  1 dimensional  2 dimensional  0 dimensional   B.  0 dimensional  1 dimensional  2 dimensional  no solution  choose   C.  2 dimensional  1 dimensional  choose  no solution  0 dimensional                D.  0 dimensional  1 dimensional  2 dimensional  choose  no solution   E.  0 dimensional  1 dimensional  2 dimensional  no solution  choose   F.  0 dimensional  no solution  choose  1 dimensional  2 dimensional                G.  0 dimensional  1 dimensional  2 dimensional  no solution  choose   H.  2 dimensional  1 dimensional  no solution  choose  0 dimensional   I.  2 dimensional  1 dimensional  no solution  choose   0 dimensional     (Click on a graph to enlarge it.)       "
},
{
  "id": "system-3-check-1",
  "level": "2",
